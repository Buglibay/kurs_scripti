...
<?php
    ...
    if(mysqli_num_rows($result) > 0){
        while($row=mysqli_fetch_assoc($result)){
          	?>
						<img src="admin/adminlab/sekil/siteimg/<?=$row['site_logo']?>" alt="">
 
<p><?=$row['footer_text']?></p>
						<div class="social pt-1">
							<a href="<?=$row['facebook']?> "target="blank"><i class="biq  fa fa-twitter-square"></i></a>
							<a href="<?=$row['instagram']?>"target="blank"><i class="biq  fa fa-facebook-square"></i></a>
